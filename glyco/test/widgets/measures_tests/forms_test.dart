...
void main() async {
  ...
  Future<void> _buildNutritionForm(WidgetTester tester) async {
    await tester.pumpWidget(
      MultiProvider(
        ...
        child: MaterialApp(
          home: Scaffold(body: NutritionForm(FontAwesomeIcons.hamburger)),
        ),
      ),
    );
  }
  ...
  Future<void> _buildExerciseForm(WidgetTester tester) async {
    await tester.pumpWidget(
      MultiProvider(
        ...
        child: MaterialApp(
          home: Scaffold(body: ExerciseForm()),
        ),
      ),
    );
  }

  Future<void> _buildGlucoseManualForm(WidgetTester tester) async {
    await tester.pumpWidget(
      MultiProvider(
        providers: [
          ChangeNotifierProvider<Measurement>.value(
        ...
        child: MaterialApp(
          home: Scaffold(body: GlucoseManualForm()),
        ),
      ),
    );
  }

  Future<void> _buildNutritionManualForm(WidgetTester tester) async {
    await tester.pumpWidget(
      MultiProvider(
        providers: [
          ChangeNotifierProvider<Measurement>.value(
        ...
        child: MaterialApp(
          home: Scaffold(body: NutritionManualForm()),
        ),
      ),
    );
  }

  Future<void> _buildExerciseManualForm(WidgetTester tester) async {
    await tester.pumpWidget(
      MultiProvider(
        providers: [
          ChangeNotifierProvider<Measurement>.value(
        ...
        child: MaterialApp(
          home: Scaffold(body: ExerciseManualForm()),
        ),
      ),
    );
  }

  testWidgets('Nutrition Form', (WidgetTester tester) async {
  ...
  testWidgets('Exercise Form', (WidgetTester tester) async {
  ...
  testWidgets('Glucose Manual Form', (WidgetTester tester) async {
    await _buildGlucoseManualForm(tester);
    expect(find.byType(Form), findsOneWidget);
    expect(find.byType(Icon), findsOneWidget);
    expect(find.byType(Text), findsNWidgets(4));
    expect(find.byType(TextFormField), findsNWidgets(1));
  ...
  testWidgets('Nutrition Manual Form', (WidgetTester tester) async {
    await _buildNutritionManualForm(tester);
    expect(find.byType(Form), findsOneWidget);
    expect(find.byType(Icon), findsOneWidget);
    expect(find.byType(Text), findsNWidgets(4));
    expect(find.byType(TextFormField), findsNWidgets(1));
  ...
  testWidgets('Exercise Manual Form', (WidgetTester tester) async {
    await _buildExerciseManualForm(tester);
    expect(find.byType(Form), findsOneWidget);
    expect(find.byType(Icon), findsOneWidget);
    expect(find.byType(Text), findsNWidgets(4));
    expect(find.byType(TextFormField), findsNWidgets(1));
